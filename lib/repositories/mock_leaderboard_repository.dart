...
class MockLeaderboardRepository implements LeaderboardRepository {
  final List<UserLeaderboardStats> _stats = [
    UserLeaderboardStats(
      ...
      username: 'AlexLift',
      weeklyVolume: 42500,
      monthlyVolume: 170000,
    ),
    UserLeaderboardStats(
      userId: '2',
      username: 'SarahSquats',
      weeklyVolume: 38200,
      monthlyVolume: 152000,
    ),
    UserLeaderboardStats(
      userId: '3',
      username: 'MikeIron',
  ...
  Stream<List<UserLeaderboardStats>> getWeeklyLeaderboard() {
    return Stream.value(
      _stats..sort((a, b) => b.weeklyVolume.compareTo(a.weeklyVolume)),
    );
  }
  ...
  Stream<List<UserLeaderboardStats>> getMonthlyLeaderboard() {
    return Stream.value(
      _stats..sort((a, b) => b.monthlyVolume.compareTo(a.monthlyVolume)),
    );
  }
